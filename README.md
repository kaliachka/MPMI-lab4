...
Таким образом, наилучшим по показателям оказался случай с режимом 'wrap', голубая ломаная и это значение мы и примем за оптимальное для данного случая.
